...
export const LAND_REGISTRY_SORT_COLUMNS: Record<NonNullable<LandSearchDto['sortBy']>, string> = {
...
export const REALTY_REGISTRY_SORT_COLUMNS: Record<NonNullable<RealtySearchDto['sortBy']>, string> = {
